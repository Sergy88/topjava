...
public class MealTestData {
    ...
    public static final TestMatcher<Meal> MEAL_MATCHER_NO_ID_NO_USER = TestMatcher.usingIgnoringFieldsComparator(Meal.class, "user", "id");
    public static final TestMatcher<MealTo> MEAL_TO_MATCHER_NOEXCESS = TestMatcher.usingIgnoringFieldsComparator(MealTo.class, "excess");
